"""Handle communication between ARC VISION and other applications."""
...
class Dispatcher:
    """Handle communication between ARC VISION and communicators."""
    ...
    def restore_runtime_state(self) -> None:
        """Replay persisted runtime overrides once ARC VISION startup completes.
