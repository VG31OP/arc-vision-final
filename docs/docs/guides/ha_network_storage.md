...
## Setting Up Remote Storage For ARC VISION
...
2. Name the share `frigate` (required by ARC VISION's existing network storage layout)
3. Choose type `media`
