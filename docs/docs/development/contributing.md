...
This repository holds the main ARC VISION application and all of its dependencies.

Fork the ARC VISION repository to your own GitHub profile, then clone the forked repo to your local machine.
...
### ARC VISION Home Assistant App

This repository holds the Home Assistant App, for use with Home Assistant OS and compatible installations. It is the piece that allows you to run ARC VISION from your Home Assistant Supervisor tab.

Fork [arc-vision/arc-vision-hass-addons](#arc-vision-home-assistant-app) to your own Github profile, then clone the forked repo to your local machine.

### ARC VISION Home Assistant Integration

This repository holds the custom integration that allows your Home Assistant installation to automatically create entities for your ARC VISION instance, whether you are running ARC VISION as a standalone Docker container or as a [Home Assistant App](#arc-vision-home-assistant-app).

Fork [arc-vision/arc-vision-hass-integration](#arc-vision-home-assistant-integration) to your own GitHub profile, then clone the forked repo to your local machine.
...
Upon opening, you should be prompted to open the project in a remote container. This will build a container on top of the base ARC VISION container with all the development dependencies installed. This ensures everyone uses a consistent development environment without the need to install any dependencies on your host machine.
...
#### 4. Run ARC VISION from the command line

VS Code will start the Docker Compose file for you and open a terminal window connected to `arc-vision-dev`.
...
- All [core](#core) prerequisites _or_ another running ARC VISION instance locally available
- Node.js 20

### Making changes

#### 1. Set up a ARC VISION instance

The Web UI requires an instance of ARC VISION to interact with for all of its data. You can either run an instance locally (recommended) or attach to a separate instance accessible on your network.

To run the local instance, follow the [core](#core) development instructions.

If you won't be making any changes to the ARC VISION HTTP API, you can attach the web development server to any ARC VISION instance on your network. Skip this step and go to [3a](#3a-run-the-development-server-against-a-non-local-instance).
...
The docs are built using [Docusaurus v3](https://docusaurus.io). Please refer to the Docusaurus docs for more information on how to modify ARC VISION's documentation.
...
ARC VISION uses [Weblate](https://weblate.org) to manage translations of the Web UI. To contribute translation, sign up for an account at Weblate and navigate to the ARC VISION Intelligent Surveillance Platform project:
