...
ARC VISION includes the object labels listed below from the Google Coral test data.
...
By default, ARC VISION only tracks `person`. To track additional object types, add them to the tracked objects list.
