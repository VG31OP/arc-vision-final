...
import IncidentReviewWorkspace from "@/components/incidents/IncidentReviewWorkspace";
...
export default function Events() {
  ...
  const [viewMode, setViewMode] = useOverlayState<"workspace" | "timeline">(
    "view",
    "workspace",
  );
  ...
  if (recording) {
    ...
    return motionSearchCamera ? (
      ...
      <div className="flex size-full flex-col overflow-hidden">
        {/* Mode Switcher Bar */}
        <div className="flex shrink-0 items-center justify-between border-b border-slate-800 bg-background_alt px-4 py-2 text-xs font-mono text-slate-300">
        ...
        <div className="flex-1 overflow-hidden">
          {viewMode === "workspace" ? (
            <IncidentReviewWorkspace
              events={reviews || []}
              onSelectIncident={(segment: ReviewSegment) =>
                setSelectedIncidentDetail(segment)
              }
