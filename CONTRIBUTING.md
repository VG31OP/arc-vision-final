# Contributing to ARC VISION

Thank you for your interest in contributing to ARC VISION. This document covers the expectations and guidelines for contributions. Please read it before submitting a pull request.
...
1. **Check for existing discussion.** Search [feature requests](issues) and [discussions](ARC_VISION_OPEN_SOURCE_NOTICES.md) to see if it's been proposed or discussed. Feature requests tagged with "planned" are on our radar — we plan to get to them, but we don't maintain a public roadmap or timeline. Check in with us first if you have interest in contributing to one.
2. **Start a discussion or feature request first.** This helps ensure your idea aligns with ARC VISION's direction before you invest time building it. Community interest in a feature request helps us gauge demand, though a great idea is a great idea even without a crowd behind it.
...
- **Does it fit?** Consistent with ARC VISION's architecture and design philosophy.
...
ARC VISION uses standard i18n locales(#) for managing language translations. If you'd like to help translate ARC VISION into your language:
...
- [Documentation](ARC_VISION_DEMO_RUNBOOK.md)
- [Discussions, Support, and Bug Reports](ARC_VISION_OPEN_SOURCE_NOTICES.md)
